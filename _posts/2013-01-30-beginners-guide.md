...
<ul class="small-block-grid-3">
  <li><img class="th" src="img/Computer.png"></li>
  <li><img class="th" src="../assets/img/examples/space.jpg"></li>
  <li><img class="th" src="../assets/img/examples/spacewalk.jpg"></li>
</ul>
</div>
   <div class="row">
    ...
    <ul class="small-block-grid-3">
    <li><p><img alt="Run Quarry" src="img/Computer.png" style="width: 325px; height: 190px; " />
        <h3 class="">Make sure you have what you need to run Quarry
    <li><p><img alt="Download Quarry" src="img/Download.png" style="width: 325px; height: 190px; " />
        <h3 class="">Make sure you have what you need to run Quarry
    <li><p><img alt="Install Quarry" src="img/Install.png" style="width: 325px; height: 190px; " />
        <h3 class="">Make sure you have what you need to run Quarry</h3></p>
	</li></h3></p></li></h3></p></li>
	</ul>
    </div>
